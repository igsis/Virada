    <footer id="main-footer" class="clearfix">
        ...
        <p class="text-center">Desenvolvido por <a id="hacklab" href="http://www.hacklab.com.br" title="hacklab/" target="_blank"><?php html::image("hacklab.png", "Hacklab", array("class" => "hacklab")); ?></a> em parceira com <b>Secretaria Municipal de Cultura</b></a></p>
    </footer>
    <!-- #main-footer -->
<?php wp_footer(); ?>
